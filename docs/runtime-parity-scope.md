...
owns the shared-memory streaming body path. The C# CultCache SoA table is not a
supported surface: nothing outside tests consumes it, and it is being parked at
a tag rather than carried. Other runtimes may add native hot paths when their
