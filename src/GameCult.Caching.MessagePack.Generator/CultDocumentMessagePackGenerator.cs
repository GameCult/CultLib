    ...
    public sealed class CultDocumentMessagePackGenerator : IIncrementalGenerator
    {
        public void Initialize(IncrementalGeneratorInitializationContext context)
        {
            ...
            context.RegisterSourceOutput(
                ...
                static (spc, pair) => EmitProvider(spc, pair.Left.AssemblyName ?? "GameCult", pair.Right));
        }
        ...
        private static void EmitProvider(SourceProductionContext context, string assemblyName, ImmutableArray<DocumentShape> shapes)
        {
            ...
            var providerName = $"GeneratedCultDocumentMetadataProvider_{SanitizeIdentifier(assemblyName)}";
            ...
            foreach (var document in documents)
            {
                ...
                foreach (var member in document.Members)
                {
                    ...
                    builder.AppendLine($"                        \"{Escape(member.TypeName)}\",");
