// GameCult swarm document-type catalog.
//
// These are CultCache document definitions for documents that cross service
// boundaries: Eve surfaces and provider advertisements, Ghostlight, Heimdall,
// Idunn, Muninn, Sleipnir, Aetheria, VoidBot, Stonks. The catalog lived in Odin
// because Odin was written first, not because Odin owns it; every service that
// decodes another service documents needs the same definitions, and a second
// copy would be a second definition of one wire format.
//
// defineDocumentType is injected rather than imported. That is how it worked in
// Odin, it keeps this file clear of the generic signature in ./document, and it
// lets a caller supply a runtime other than this package.

/** An undecoded document payload. These definitions predate typing and name fields defensively. */
export type DocumentValue = any;

export type DefineDocumentType = (definition: Record<string, unknown>) => unknown;
export type SwarmDocumentCatalog = Record<string, unknown>;

function parseObjectDocument(label: string) {
  return {
    parse(value: unknown) {
...
export function defineSwarmDocuments(defineDocumentType?: DefineDocumentType | null): SwarmDocumentCatalog {
  ...
  const surfaceDefinition = defineDocumentType({
    ...
    global: false,
    name: (value: DocumentValue) => value?.providerId || "surface",
    schema: { parse: (value: DocumentValue) => value },
    members: [
  ...
  const interfaceBindingDefinition = defineDocumentType({
    ...
    global: false,
    name: (value: DocumentValue) => value?.bindingId || value?.providerId || "interface",
  ...
  const providerAdvertisementDefinition = defineDocumentType({
    ...
    global: false,
    name: (value: DocumentValue) => value?.providerId || value?.provider?.id || "provider",
  ...
  const evePluginAdvertisementDefinition = defineDocumentType({
    ...
    global: false,
    name: (value: DocumentValue) => value?.pluginId || value?.plugin?.id || "plugin",
  ...
  const ghostlightSchemaCatalogDefinition = defineDocumentType({
    ...
    global: false,
    name: (value: DocumentValue) => value?.providerId || "gamecult.ghostlight.dungeon",
  ...
  const heimdallCommandBoundaryDefinition = defineDocumentType({
    ...
    global: false,
    name: (value: DocumentValue) => value?.boundaryId || value?.daemonId || "heimdall",
  ...
  const heimdallTransportProfileDefinition = defineDocumentType({
    ...
    global: false,
    name: (value: DocumentValue) => value?.profileId || value?.daemonId || "heimdall",
  ...
  const interfaceLayoutDefinition = defineDocumentType({
    ...
    global: false,
    name: (value: DocumentValue) => value?.layoutId || value?.providerId || "odin.providers",
  ...
  const idunnDaemonHealthDefinition = defineDocumentType({
    ...
    global: false,
    name: (value: DocumentValue) => value?.daemonId || value?.daemon_id || "daemon",
  ...
  const idunnCommandBoundaryDefinition = defineDocumentType({
    ...
    global: false,
    name: (value: DocumentValue) => value?.boundary_id || value?.boundaryId || value?.daemon_id || value?.daemonId || "daemon",
  ...
  const idunnTransportProfileDefinition = defineDocumentType({
    ...
    global: false,
    name: (value: DocumentValue) => value?.profile_id || value?.profileId || value?.daemon_id || value?.daemonId || "daemon",
  ...
  const muninnCaptureStreamDefinition = defineDocumentType({
    ...
    global: false,
    name: (value: DocumentValue) => value?.stream_id || value?.streamId || "capture-stream",
  ...
  const muninnCaptureStreamCommandDefinition = defineDocumentType({
    ...
    global: false,
    name: (value: DocumentValue) => value?.command_id || value?.commandId || value?.stream_id || value?.streamId || "capture-stream-command",
  ...
  const muninnCommandBoundaryDefinition = defineDocumentType({
    ...
    global: false,
    name: (value: DocumentValue) => value?.boundary_id || value?.boundaryId || value?.daemon_id || value?.daemonId || "muninn",
  ...
  const muninnMoveControllerStateDefinition = defineDocumentType({
    ...
    global: false,
    name: (value: DocumentValue) => value?.stream_id || value?.streamId || value?.move_id || value?.moveId || "move-controller-state",
  ...
  const muninnHidControllerStateDefinition = defineDocumentType({
    ...
    global: false,
    name: (value: DocumentValue) => value?.stream_id || value?.streamId || value?.device_id || value?.deviceId || "hid-controller-state",
  ...
  const muninnMoveIdentityDefinition = defineDocumentType({
    ...
    global: false,
    name: (value: DocumentValue) => value?.identity_id || value?.identityId || value?.move_id || value?.moveId || "move-identity",
  ...
  const muninnMoveLightCommandDefinition = defineDocumentType({
    ...
    global: false,
    name: (value: DocumentValue) => value?.command_id || value?.commandId || value?.move_id || value?.moveId || "move-light-command",
  ...
  const muninnMoveMarkerCandidateDefinition = defineDocumentType({
    ...
    global: false,
    name: (value: DocumentValue) => value?.stream_id || value?.streamId || value?.camera_id || value?.cameraId || "move-marker-candidate",
  ...
  const muninnObsStreamCatalogDefinition = defineDocumentType({
    ...
    global: false,
    name: (value: DocumentValue) => value?.catalog_id || value?.catalogId || value?.host_id || value?.hostId || "muninn",
  ...
  const muninnQuestAccessDefinition = defineDocumentType({
    ...
    global: false,
    name: (value: DocumentValue) => value?.access_id || value?.accessId || value?.serial || "quest-access",
  ...
  const muninnTelemetrySurfaceDefinition = defineDocumentType({
    ...
    global: false,
    name: (value: DocumentValue) => value?.surface_id || value?.surfaceId || value?.host_id || value?.hostId || "muninn-telemetry",
  ...
  const muninnTransportProfileDefinition = defineDocumentType({
    ...
    global: false,
    name: (value: DocumentValue) => value?.profile_id || value?.profileId || value?.daemon_id || value?.daemonId || "muninn",
  ...
  const SleipnirInputMappingDefinition = defineDocumentType({
    ...
    global: false,
    name: (value: DocumentValue) => value?.providerId || value?.provider_id || "sleipnir",
  ...
  const aetheriaAssetManifestDefinition = defineDocumentType({
    ...
    global: false,
    name: (value: DocumentValue) => value?.runId || value?.run_id || "aetheria-assets",
    schema: parseObjectDocument("Aetheria asset manifest"),
  });
  const aetheriaGravityViewportDefinition = defineDocumentType({
    type: "gamecult.fields.gravity",
    schemaName: "gamecult.fields.gravity",
    schemaId: "gamecult.fields.gravity.v1",
    schemaVersion: "gamecult.fields.gravity.v1",
    global: false,
    name: (value: DocumentValue) => value?.viewportId || value?.viewport_id || "aetheria-gravity",
    schema: parseObjectDocument("Aetheria gravity viewport"),
  });
  const aetheriaObjectsViewportDefinition = defineDocumentType({
    type: "gamecult.fields.objects",
    schemaName: "gamecult.fields.objects",
    schemaId: "gamecult.fields.objects.v1",
    schemaVersion: "gamecult.fields.objects.v1",
    global: false,
    name: (value: DocumentValue) => value?.viewportId || value?.viewport_id || "aetheria-objects",
    schema: parseObjectDocument("Aetheria objects viewport"),
  });
  const aetheriaRenderSplatsViewportDefinition = defineDocumentType({
    type: "gamecult.fields.splats",
    schemaName: "gamecult.fields.splats",
    schemaId: "gamecult.fields.splats.v1",
    schemaVersion: "gamecult.fields.splats.v1",
    global: false,
    name: (value: DocumentValue) => value?.viewportId || value?.viewport_id || "aetheria-render-splats",
  ...
  const operatorStateDefinition = defineDocumentType({
    ...
    global: false,
    name: (value: DocumentValue) => value?.service || value?.providerId || "operator",
  ...
  const viliCommandBoundaryDefinition = defineDocumentType({
    ...
    global: false,
    name: (value: DocumentValue) => value?.boundaryId || value?.daemonId || "vili",
  ...
  const viliTransportProfileDefinition = defineDocumentType({
    ...
    global: false,
    name: (value: DocumentValue) => value?.profileId || value?.daemonId || "vili",
  ...
  const weksaOperatorStateDefinition = defineDocumentType({
    ...
    global: false,
    name: (value: DocumentValue) => value?.daemon_id || value?.daemonId || value?.provider_id || value?.providerId || "weksa",
  ...
  const weksaCommandBoundaryDefinition = defineDocumentType({
    ...
    global: false,
    name: (value: DocumentValue) => value?.boundary_id || value?.boundaryId || value?.daemon_id || value?.daemonId || "weksa",
  ...
  const weksaTransportProfileDefinition = defineDocumentType({
    ...
    global: false,
    name: (value: DocumentValue) => value?.profile_id || value?.profileId || value?.daemon_id || value?.daemonId || "weksa",
  ...
  const stonksRequestEventDefinition = defineDocumentType({
    ...
    global: false,
    name: (value: DocumentValue) => value?.id || "request",
  ...
  const stonksCommandBoundaryDefinition = defineDocumentType({
    ...
    global: false,
    name: (value: DocumentValue) => value?.boundaryId || value?.daemonId || "stonks",
  ...
  const stonksTransportProfileDefinition = defineDocumentType({
    ...
    global: false,
    name: (value: DocumentValue) => value?.profileId || value?.daemonId || "stonks",
  ...
  const streamPixelsCommandBoundaryDefinition = defineDocumentType({
    ...
    global: false,
    name: (value: DocumentValue) => value?.boundaryId || value?.daemonId || "streampixels",
  ...
  const streamPixelsTransportProfileDefinition = defineDocumentType({
    ...
    global: false,
    name: (value: DocumentValue) => value?.profileId || value?.daemonId || "streampixels",
