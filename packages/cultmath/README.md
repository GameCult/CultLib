...
- every HLSL swizzle (`xyzw` and `rgba`, repeats readable, non-repeating
  masks writable) and every HLSL mixed constructor, generated by
  `tools/generate-swizzles.ps1`
