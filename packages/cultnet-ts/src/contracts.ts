...
import loginSchema from "../../../contracts/cultnet/cultnet.login.schema.json";
import registerSchema from "../../../contracts/cultnet/cultnet.register.schema.json";
import verifySchema from "../../../contracts/cultnet/cultnet.verify.schema.json";
import loginSuccessSchema from "../../../contracts/cultnet/cultnet.login-success.schema.json";
import errorSchema from "../../../contracts/cultnet/cultnet.error.schema.json";
import sampleChangeNameSchema from "../../../contracts/cultnet/cultnet.sample-change-name.schema.json";
import sampleChatSchema from "../../../contracts/cultnet/cultnet.sample-chat.schema.json";
import documentPutSchema from "../../../contracts/cultnet/cultnet.document-put.schema.json";
import documentDeleteSchema from "../../../contracts/cultnet/cultnet.document-delete.schema.json";
import rawDocumentRecordSchema from "../../../contracts/cultnet/cultnet.raw-document-record.schema.json";
import documentPutRawSchema from "../../../contracts/cultnet/cultnet.document-put-raw.schema.json";
import documentMutationContractSchema from "../../../contracts/cultnet/cultnet.document-mutation-contract.schema.json";
import transportProfileSchema from "../../../contracts/cultnet/cultnet.transport-profile.schema.json";
import snapshotRequestSchema from "../../../contracts/cultnet/cultnet.snapshot-request.schema.json";
import snapshotResponseSchema from "../../../contracts/cultnet/cultnet.snapshot-response.schema.json";
import snapshotResponseRawSchema from "../../../contracts/cultnet/cultnet.snapshot-response-raw.schema.json";
import databaseSubscribeSchema from "../../../contracts/cultnet/cultnet.database-subscribe.schema.json";
import databaseUnsubscribeSchema from "../../../contracts/cultnet/cultnet.database-unsubscribe.schema.json";
import databaseChangeRawSchema from "../../../contracts/cultnet/cultnet.database-change-raw.schema.json";
import schemaDescriptorSchema from "../../../contracts/cultnet/cultnet.schema-descriptor.schema.json";
import schemaCatalogRequestSchema from "../../../contracts/cultnet/cultnet.schema-catalog-request.schema.json";
import schemaCatalogResponseSchema from "../../../contracts/cultnet/cultnet.schema-catalog-response.schema.json";
import shardCatalogRequestSchema from "../../../contracts/cultnet/cultnet.shard-catalog-request.schema.json";
import shardCatalogResponseSchema from "../../../contracts/cultnet/cultnet.shard-catalog-response.schema.json";
import operationRequestSchema from "../../../contracts/cultnet/cultnet.operation-request.schema.json";
import operationResponseSchema from "../../../contracts/cultnet/cultnet.operation-response.schema.json";
import verseCatalogRequestSchema from "../../../contracts/cultnet/cultmesh.verse-catalog-request.schema.json";
import verseCatalogResponseSchema from "../../../contracts/cultnet/cultmesh.verse-catalog-response.schema.json";
import sessionOpenSchema from "../../../contracts/cultnet/cultmesh.session-open.schema.json";
import sessionAcceptedSchema from "../../../contracts/cultnet/cultmesh.session-accepted.schema.json";
import ghostlightAgentStateSchema from "../../../contracts/cultnet/ghostlight.agent-state.schema.json";
...
export interface CultNetOperationRequestMessage {
...
export interface CultNetOperationResponseMessage {
